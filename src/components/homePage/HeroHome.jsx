  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-auto bg-black text-white">
      <div className="flex flex-col justify-center items-center h-auto md:w-[60%] sm:w-[50%] w-[90%] gap-10 py-20">
        ...
        <div className="flex flex-col justify-center items-center">
          <button type="submit" className="px-7 text-lg font-semibold capitalize py-3 cursor-pointer shadow-md hover:shadow-lg transition-all duration-300 ease-in-out bg-blue-600 hover:bg-blue-700 rounded-[12px]">View Openings</button>
        </div>
      </div>
    </div>
  );
